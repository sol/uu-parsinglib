...
pSem :: t
     -> MergeSpec (d, [Freq (P st (d -> d))], t -> d -> t4)
     -> MergeSpec (d, [Freq (P st (d -> d))], (t4 -> t5) -> d -> t5)
...
pBetween :: Int -> Int -> P t a -> MergeSpec ([a], [Freq (P t ([a] -> [a]))], b -> b)
